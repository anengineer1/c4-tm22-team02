...
public class CreateClientView extends JPanel {
	...
	private JPanel panel_crear_cliente;
	 ...
	 */
	public CreateClientView(JPanel panel_crear_cliente){
		
		this.panel_crear_cliente = panel_crear_cliente;
		...
		panel_crear_cliente.add(lblNewLabel_2);
		...
		panel_crear_cliente.add(lblNewLabel);
		...
		panel_crear_cliente.add(lblCreate1);
		...
		panel_crear_cliente.add(tfCreate1);
		...
		panel_crear_cliente.add(lblCreate2);
		...
		panel_crear_cliente.add(tfCreate2);
		...
		panel_crear_cliente.add(lblCreate3);
		...
		panel_crear_cliente.add(tfCreate3);
		...
		panel_crear_cliente.add(lblCreate4);
		...
		panel_crear_cliente.add(tfCreate4);
		...
		panel_crear_cliente.add(btnNewButton);
	}

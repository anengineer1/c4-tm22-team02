 ...
 *
 */
public class DeleteVideoView extends JPanel {
	...
	public DeleteVideoView() {
		this.setToolTipText("Eliminar video de la base de datos");
		this.setBackground(new Color(0, 64, 128));
		//this.setLayout(null);

		// Label Tab Read Client
		JLabel lbl_consulta_cliente = new JLabel("Elimina Video");
		...
		lbl_consulta_cliente.setToolTipText("Elimina video");
		...
		JLabel lblRead1 = new JLabel("Titulo");
